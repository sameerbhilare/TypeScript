...
module.exports = {
  ...
  output: {
    ...
    // publicPath: 'dist', // not required for production mode
  },
  ...
  //devtool: 'source-map', // not for production mode
  ...
  // plugins - applied to the entire project/workflow
  plugins: [
    // plugin which automatically deletes everything in the dist folder before new output is written there.
